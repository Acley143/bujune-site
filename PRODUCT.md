...
This is a template — replace this paragraph with your own background, and update the placeholder content in components/site/ to match. The site is built to convert readers into "let's talk" conversations for full-time roles.
...
- **Let the work speak.** The proof is in the projects listed in Highlights and Projects. Let the reader infer your skill level from the work itself.
